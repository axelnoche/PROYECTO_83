...
var names = ["Libro familiar","Jesus Nochebuena - Abuelo", "Jesus Jr - Padre", "Nallely Arce - Madre", "Hanna Nochebuena - Hermana", "Gia Nochebuena - Hermana"];
...
function update()
{
    ...
    console.log("La edad más alta es de: ", max_number);

    var min_number = Math.min.apply(Math, age);
    console.log("La edad más baja es de: ", min_number);
}